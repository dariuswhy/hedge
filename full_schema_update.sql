...
drop policy if exists "Users view own capital" on public.invested_capital;
drop policy if exists "Users view own ledger" on public.ledger;
...
create policy "Users view own capital" on public.invested_capital for select using ( true );
create policy "Users view own ledger" on public.ledger for select using ( true );
create policy "Hedge pools viewable by authenticated users" on public.hedge_pools for select using ( true );
create policy "Pool members viewable by authenticated users" on public.hedge_pool_members for select using ( true );
create policy "Pool trades viewable by authenticated users" on public.hedge_pool_trades for select using ( true );
